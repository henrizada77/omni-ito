// Legal contract templates for Omni-ITO
// Extracted from Dashboard.tsx to keep data separate from logic

export const CONTRATO_EXPERIENCIA_TEXT = `CONTRATO INDIVIDUAL DE TRABALHO A TÍTULO DE EXPERIÊNCIA
...
export const REGIMENTO_INTERNO_TEXT = `TERMO DE CIÊNCIA E COMPROMISSO COM O REGIMENTO INTERNO

Eu, {{nome}}, pessoa física, inscrita no CPF sob o nº {{cpf}} , residente e domiciliado(a) em Rua {{endereco}}, colaborador(a) da empresa BIOLIFE CLINICA MEDICA LTDA, declaro que recebi, li e compreendi integralmente o Regimento Interno, bem como as normas, políticas, procedimentos, diretrizes e orientações nele estabelecidas.
...
export const BANCO_HORAS_TEXT = `TERMO DE FORMALIZAÇÃO DE BANCO DE HORAS
...
// Versão oficial (Word) do contrato de experiência, com endereço "Maceió/AL",
// blocos de assinatura EMPREGADO(A)/EMPREGADORA e campos de testemunha. As mesmas
// {{variáveis}} dos demais modelos — o fluxo de envio/assinatura as substitui.
export const CONTRATO_EXPERIENCIA_TESTEMUNHAS_TEXT = `CONTRATO INDIVIDUAL DE TRABALHO A TÍTULO DE EXPERIÊNCIA

Pelo presente instrumento particular, de um lado BIOLIFE CLÍNICA MÉDICA LTDA., pessoa jurídica de direito privado, inscrita no CNPJ sob o nº 37.037.182/0001-85, com sede na Rua Olavo Macedo Ribeiro, nº 320, bairro Jatiúca, Maceió/AL, doravante denominada EMPREGADORA, e, de outro lado, {{nome}}, pessoa física, inscrita no CPF sob o nº {{cpf}}, residente e domiciliado(a) em Rua {{endereco}}, Maceió/AL, doravante denominado(a) EMPREGADO(A), têm entre si justo e contratado o presente CONTRATO DE TRABALHO A TÍTULO DE EXPERIÊNCIA, nos termos do artigo 443, §2º, alínea "c", da CLT, mediante as cláusulas e condições a seguir:
...
// Termo de ciência (só o colaborador assina). A linha "___" + "EMPREGADO(A):"
// no fim é o que a Edge Function usa para ancorar a assinatura no lugar certo.
export const TERMO_MONITORAMENTO_TEXT = `TERMO DE CIÊNCIA SOBRE SISTEMA DE MONITORAMENTO POR CÂMERAS COM CAPTAÇÃO DE IMAGEM E ÁUDIO
...
// Termo de confidencialidade. Duas linhas de assinatura: "Empregador" (rep) e
// "Empregado(a)" (colab). A Edge Function distingue as duas pela regra
// EMPREGADO(?!R), já que "empregado" é substring de "empregador".
export const TERMO_CONFIDENCIALIDADE_TEXT = `TERMO DE CONFIDENCIALIDADE
...
// Termo de entrega de EPI. Tabela achatada em lista (o PDF é texto puro).
// Assinaturas: "Empregado(a)" (colab, recebe) e "Responsável ... (Empregador)" (rep).
export const TERMO_EPI_TEXT = `TERMO DE ENTREGA DE EPI (Equipamento de Proteção Individual)
...
// Termo aditivo LGPD. Assinaturas: "COLABORADOR" (colab) e "EMPREGADORA" (rep).
export const TERMO_LGPD_TEXT = `TERMO ADITIVO REFERENTE À LEI GERAL DE PROTEÇÃO DE DADOS
...
export const DEFAULT_MODELS = [
  ...
  { id: '5', titulo: 'Contrato de Experiência (com Testemunhas)', conteudo: CONTRATO_EXPERIENCIA_TESTEMUNHAS_TEXT },
  { id: '6', titulo: 'Termo de Ciência — Monitoramento por Câmeras (Imagem e Áudio)', conteudo: TERMO_MONITORAMENTO_TEXT },
  { id: '7', titulo: 'Termo de Confidencialidade', conteudo: TERMO_CONFIDENCIALIDADE_TEXT },
  { id: '8', titulo: 'Termo de Entrega de EPI', conteudo: TERMO_EPI_TEXT },
  { id: '9', titulo: 'Termo Aditivo LGPD (Proteção de Dados)', conteudo: TERMO_LGPD_TEXT },
];
